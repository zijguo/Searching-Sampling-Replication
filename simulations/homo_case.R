...
### Date: 05/22/2022
### Author: Zhenyu WANG
### Aim: Investigate settings S1 to S5 when homo errors.
library(MASS)
library(intervals)
source("helpers.R")
source("TSHT-ldim.R")
...
colnames(CI.mat) = c("Oracle-L","Oracle-U","TSHT-L","TSHT-U","CIIV-L","CII-U")
...
rm(list=setdiff(ls(), c("setting", "IV.str", "VIO.str", "n", "Cov.mat", "Leng.mat", "Rule.mat" ,"length.union05", "cover.union05","CI.mat","sim.round")))
